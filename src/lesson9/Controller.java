...
public class Controller {
    ...
    public void playersInit() throws NoSuchElementException {
        ...
        else if (mode.equals("auto")) player2 = createRobot();
        else {
            player1 = null;
    ...
    private Player createRobot() {
        if (player1.getSign() == Cell.CROSS)
            return new Robot(Cell.ZERO, field);
        else  return new Robot(Cell.CROSS, field);
    }

    public boolean action1() {
        int[] coordinates = player1.positionChoiсe();
        return field.setCell(coordinates[0], coordinates[1], player1.getSign());
    }

    public boolean action2() {
        int[] coordinates = player2.positionChoiсe();
        return field.setCell(coordinates[0], coordinates[1], player2.getSign());
    }
